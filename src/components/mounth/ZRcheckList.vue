        ...
        <div class="contentRQ">
          <div class="list-block">
            <ul>
              ...
              <li class="item-content" @click='toRouter'>
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner" id="Atblist">
                  <div class="item-after">张三</div>
                  <div class="item-after jibie">副科长</div>
                ...
                <div class="item-inner" id="Atblist">
                  <div class="item-after">张三</div>
                  <div class="item-after jibie">科员</div>
                  <div class="item-after">综合部</div>
                  <div class="item-after">99</div>
                </div>
              </li>
    ...
    export default{
        ...
        methods: {
            ...
            getEventTrigger(event) //获取当前点击的元素的innerhtml用于判断人员级别
              ...
              var a=x.getElementsByTagName("div")[1].getElementsByTagName("div")[1].innerHTML;
                  return a;
              },
            toRouter(){
                let jibie = this.getEventTrigger(event);
                if(jibie == "科员"){
                    this.$router.push('/rorLevel0')
                }else if(jibie == "科长" || jibie == "副科长"){
